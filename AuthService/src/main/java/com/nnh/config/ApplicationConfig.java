...
public class ApplicationConfig {
	...
	@Autowired
	public ApplicationConfig(TokenRepository tokenRep) {
		super();
	...
	public UserDetailsService userDetailsService() {
		return new UserDetailsService() {
			...
			public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
				TokenEntity token = tokenRep.findOneByUsername(username);
				UserEntity user = new UserEntity.Builder().userame(token.getUsername()).build();
				return user;
			}
		};
	}
